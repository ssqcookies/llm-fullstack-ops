...
from pkg.response import success_resp
...
class LanguageModelHandler:
    ...
    def get_language_models(self):
        """获取所有的语言模型提供商信息"""
        return success_resp(self.language_model_service.get_language_models())

    @login_required
    def get_language_model(self, provider_name: str, model_name: str):
        """根据传递的提供商名字+模型名字获取模型详细信息"""
        return success_resp(self.language_model_service.get_language_model(provider_name, model_name))
