...
class WorkflowHandler:
    ...
    def create_workflow(self):
        ...
        return success_resp({"id": workflow.id})
    ...
    def get_workflow(self, workflow_id: UUID):
        ...
        return success_resp(resp.dump(workflow))
    ...
    def get_workflows_with_page(self):
        ...
        return success_resp(PageModel(list=resp.dump(workflows), paginator=paginator))
    ...
    def get_draft_graph(self, workflow_id: UUID):
        ...
        return success_resp(draft_graph)
