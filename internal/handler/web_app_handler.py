...
from pkg.response import success_resp, validation_resp, success_message, compact_generate_response
...
class WebAppHandler:
    ...
    def get_conversations(self, token: str):
        ...
        return success_resp(resp.dump(conversations))
